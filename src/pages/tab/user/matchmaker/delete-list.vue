...
const loadMore = () => {
    request.post<UserInfoType[]>('matchmaker/getApplyDeleteList', null).then((res) => {
...
const clickGridHandler = (e: any) => {
    uni.navigateTo({
        url: '/pages/tab/user/matchmaker/delete-list-user-info?item=' + encodeURIComponent(JSON.stringify(e)),
    });
}
</script>